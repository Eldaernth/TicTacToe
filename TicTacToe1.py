...
def title():
    print("""                                     TTTTTTTTTTTTTTTTTTTTTTT  iiii                                                             
                                     T:::::::::::::::::::::T i::::i                                                           
                                     T:::::::::::::::::::::T  iiii                                                            
                                     T:::::TT:::::::TT:::::T                                                                  
...
def credit():
    subprocess.call("clear",shell=True)
    print(""" Created by:                 dBBBBBb  dBBBP     dBBBBb  dBBBBP    dBBBBb  dBBBP 
                             dB'               dBP dBP.BP                   
                             dBBBP' dBBP      dBP dBP dBP.BP    dBBBB   dBBP    
                             dBP    dBP       dBP dBP dBP.BP    dB' BB  dBP      
                             dBP    dBBBBP    dBP dBP dBBBBP    dBBBBBB dBBBBP\n Peti\n Norbi\n Geri\n""")
    print("1.back")
    selection=int(input("Enter choice:"))                            
    if selection==1:
        mainMenu()
